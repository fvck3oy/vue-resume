		...
		<div class="con">
			<div class="con-inside">
				<b-container class="p-5">
					<b-row>
						<b-col cols="12 bg-full-name">
							<div class="full-name">PUMIN SWANGJANG</div>
							<div>Full Stack Web Developer</div>
						</b-col>
					</b-row>
					<b-row class="mt-5">
						<b-col cols="4" class="pic">
							<b-img rounded="circle" class="img-fluid" alt="Circle image" width="200px" src="https://scontent.fbkk12-3.fna.fbcdn.net/v/t1.0-9/70617299_2381769458577656_2519527514909442048_n.jpg?_nc_cat=102&_nc_oc=AQlRmpzhxGzrsvtSABMTTPiGtEsGCtn9JBQV6N2cPl5QE-JMPIsWymuTavJzkTyPrhI&_nc_ht=scontent.fbkk12-3.fna&oh=33f0219cf224e6f91615fc2e8846ca44&oe=5E084293" />
						</b-col>
						<b-col cols="8" class="aboutme">
							<div>
								<h4>About me</h4>
								{{aboutme}}<br/> BACHELOR OF ENGINEERING – ENGINEER , PRINCE OF SONGKLA UNIVERSITY ,PHUKET THAILAND.
							</div>
						</b-col>
					</b-row>
					...
					<b-row class="mt-5">
						<b-col cols="6" class="contact">
							<div>
								<h4>Contact</h4>
								<div>E-mail : puminx@hotmail.com</div>
								<div>Tel : 083-1760760</div>
								<div>Facebook :
									<a href="https://www.facebook.com/boy.reallife" target="_blank">Pumin Swangjang</a>
								</div>
							</div>
						</b-col>
						<b-col cols="6" class="contact">
					...
					<b-row class="mt-5">
						<b-row v-b-toggle.collapse-1>
							<b-col cols="12" class="btn-git outline-effect d-flex">
								<div>
									<h4>
										<i class="fab fa-github"></i> Git Repository </h4>
								</div>
								<div>
					...
					<b-row class="mt-1">
						<b-col cols="12" class="skills">
							...
							<i class=" m-2 fab fa-html5"></i>
							<i class=" m-2 fab fa-css3-alt"></i>
							<i class=" m-2 fab fa-js-square"></i>
							<i class=" m-2 fab fa-npm"></i>
							<i class=" m-2 fas fa-database"></i>
							<i class=" m-2 fab fa-node"></i>
							<i class=" m-2 fab fa-bootstrap"></i>
							<i class=" m-2 fab fa-linux"></i>
							<i class=" m-2 fab fa-ubuntu"></i>
							<i class=" m-2 fab fa-apple"></i>
...
export default {
	...
	mounted() {
		axios
			.get('https://api.github.com/users/fvck3oy/repos')
			.then(response => {
				this.repo = response.data.map(item => {
					return {
						name: item.name,
						url: item.html_url
					}
				})
				console.log('data get : ', this.repo)
			})
			.catch(error => {
				console.log(error)
			})
